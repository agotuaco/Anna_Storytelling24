...
Instead of taking the sticky note:
	...
	continue the action;
	say "You flip the sticky note over. In neat handwriting, the note says 'Trust the Iron Canary' along with a string of numbers. This looks to be the combination".
